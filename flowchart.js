...
function init() {
    ...
    myDiagram.nodeTemplateMap.add("",  // the default category
      ...
      // $(go.Panel, "Auto",
      $(go.Shape, "Rectangle",{ fill: "#282c34", stroke: "#09d3ac", strokeWidth: 3.5 },
    ...
    myDiagram.nodeTemplateMap.add("Start",
      $(go.Node, "Table", nodeStyle(),
        $(go.Panel, "Spot",
          $(go.Shape, "Circle",
            { desiredSize: new go.Size(70, 70), fill: "#282c34", stroke: "#FF9E2C", strokeWidth: 3.5 }),
